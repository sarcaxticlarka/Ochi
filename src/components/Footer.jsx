...
function Footer() {
  return (
    <div className='w-full h-screen flex gap-8 px-20 font-["Neue_Montreal"] mt-20'>
      <div className='w-1/2 h-full justify-between pb-20 flex flex-col  text-black text-[5vw] leading-[4vw] tracking-tight '>
        <div className='heading'>
          <h1 className=' font-black text-black text-[5vw] leading-[4vw] ' >EYE-</h1>
          <h1 className=' font-black text-black text-[5vw] leading-[4vw] ' >OPENING</h1>
        </div>
      ...
      <div className='w-1/2'>
        <h1 className=' font-black  text-black text-[6vw] leading-[4vw] ' >PRESENTATIONS</h1>
        <div className='dets text-[1.2vw] font-["Neue_Montreal"] text-black  mt-10'>
          <h5 className='pb-7'>S:</h5>
          <a className='block' href="#">Facebook</a>
          <a className='block' href="#">Behance</a>
          <a className='block' href="#">Twitter/X</a>
          <a className='block' href="#">Instagram</a>
          <a className='block' href="#">Linkedin</a>
        </div>
        <div className='fbottom flex w-full justify-evenly '>
          <div className='fleft w-1/2 ' >
            <div className='dets text-[1.2vw] font-["Neue_Montreal"] text-black  mt-5'>
              <h5 className='pb-7'>L:</h5>
              <a className='block underline' href="#">202-1965 W 4th Ave <br />
                Vancouver, Canada</a>
              <a className='block pt-4 underline' href="#">30 Chukarina St <br />
                Lviv, Ukrainee</a>

                <h5 className='pt-7'>E:</h5>
          <a className='block pt-4 underline ' href="#">hello@ochi.design</a>
  

            </div>
          </div>
          <div className='fbright w-1/2' >
          <div className='dets text-[1.2vw] font-["Neue_Montreal"] text-black  mt-10'>
          <h5 className='pb-7'>M:</h5>
